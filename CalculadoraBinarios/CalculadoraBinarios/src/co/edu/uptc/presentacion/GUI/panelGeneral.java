...
public class panelGeneral implements Panel,ActionListener,MouseListener,FocusListener{
	...
	// M�todo adicional para convertir decimal a binario (manejo de n�meros negativos)
	private String decimalToBinary(long decimalValue) {
	    if (decimalValue >= 0) {
	        return Long.toBinaryString(decimalValue);
	    } else {
	        // Calcular el complemento a dos para n�meros negativos
    ...
    void realizarOperacionBinarios() {
        ...
        try {
            // Verifica qu� operaci�n se est� realizando
            ...
            JOptionPane.showMessageDialog(null, "Error en la operaci�n: Ingrese valores v�lidos.");
            return;
        }
    ...
    private boolean esBinario(String numero) {
        // Verifica si la cadena es una representación válida de un número binario
        return numero.matches("[01]+");
    }

    private boolean esDecimal(String numero) {
        // Verifica si la cadena es una representación válida de un número decimal
    ...
    public void focusGained(FocusEvent e) {
        // Este m�todo se llama cuando el JTextField gana el foco (seleccionado)
    ...
    public void focusLost(FocusEvent e) {
        // Este m�todo se llama cuando el JTextField pierde el foco
